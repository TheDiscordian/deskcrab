...
| [openrsc-review.md](openrsc-review.md) | Astra High self-review at sitting start and every 45 minutes during active gameplay of objective progress, training efficiency, and player/reflex correctness, including tested improvements |
| [game-loadout.md](game-loadout.md) | Activity-specific inventory decisions, measured batch capacity, and the preparation gate before routine training |
